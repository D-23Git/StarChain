...
- **Level**: 5 (Blue Belt) - Stellar Ecosystem MVP
...
## 📸 UI Showcase & Blockchain Proof

### 🏠 Home Dashboard
![StarChain Landing](./public/assets/screenshots/home_ui.png)
*Modern deep-space aesthetic with glassmorphism effects.*

### 🛡️ Verified Dashboard
![User Dashboard](./public/assets/screenshots/dashboard_ui.png)
*Real-time tracking of signed reviews and SRT (StarChain Reward Tokens).*

### 🔗 Blockchain Confirmation (Freighter)
![Freighter Popup](./public/assets/screenshots/freighter_confirm.png)
*Cryptographic signing via Freighter Wallet ensures every review is genuine.*
...
We conducted comprehensive user testing with **5 real Stellar testnet users** to validate our MVP.
